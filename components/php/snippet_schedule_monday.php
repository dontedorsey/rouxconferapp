<div class="tab-pane active" id="monday">
	...
	<section class="media">
		<a href="artists.php#LaVonne_LaRue" class="pull-left" data-toggle="tooltip" title data-original-title="LaVonne LaRue"><img class="img-rounded" src="img/artists/LaVonne_LaRue_tn.jpg" alt="Photo of LaVonne LaRue"></a>
	...
	<section class="media">
		<a href="artists.php#Lorenzo_Garcia" class="pull-left" data-toggle="tooltip" title data-original-title="Lorenzo Garcia"><img class="pull-left img-rounded" src="img/artists/Lorenzo_Garcia_tn.jpg" alt="Photo of Lorenzo Garcia"></a>
	  <div class="media-body">
	  	<h4>11:00am-1pm</h4>
			<h3>Art in Full Bloom</h3>
			<h4>Victoria Hall</h4>
			<p>Drawing and painting flowers may seem like a first-year art student's assignment, but Lorenzo Garcia brings depth, shadows, light, and color to new heights with his unique technique of painting on canvas with ceramic glaze. This session is sure to be a hit with mixed media buffs.</p>
	  </div><!-- media-body -->
	</section><!-- media -->
