<article class="aboutthevenues">
	...
	<article class="media">
		<img class="pull-left" src="img/hotels/contempo.jpg" alt="Hotel Contempo">
	...
	<article class="media">
			...
			<img class="pull-right img-rounded" src="img/hotels/phillips.jpg" alt="Phillips of Belltown Hotel">
	...
	<article class="media">
			...
			<img class="pull-right img-rounded" src="img/hotels/otter.jpg" alt="The Otter Renaissance Hotel">
	...
	<article class="media">
			...
			<img class="pull-right img-rounded" src="img/hotels/rage.jpg" alt="The Rage Hotel">
	...
	<article class="media">
			...
			<img class="pull-right img-rounded" src="img/hotels/gwendoline.jpg" alt="Gwendoline's Fancy Hotel">
